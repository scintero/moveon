...
public class PolarMessageParser implements MessageParser {
	...
	public PolarMessageParser(Context context) {
	 ...
	 * 
	 * @param buffer
	 *            an array of bytes to parse
	 * @param i
	 *            buffer offset to beginning of packet.
	...
	public Sensor.SensorDataSet parseBuffer(byte[] buffer) {
		...
		i.putExtra("beats", String.valueOf(lastHeartRate));
		mContext.sendBroadcast(i);

		// Heart Rate
		Sensor.SensorData.Builder b = Sensor.SensorData.newBuilder().setValue(heartRate)
	 ...
	 * frequent are 8 and 10. We will wait for 16 bytes. This way, we are
	 * assured of getting one good one.
	 *
