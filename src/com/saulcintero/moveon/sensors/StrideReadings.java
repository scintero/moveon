...
/**
 * A history of Zephyr stride counter reading. These can be used as an alternate
 * method to calculate the correct cadence. This is a work around for an issue
 * with some HxM firmware.
 *
...
public class StrideReadings {
	...
	public int getCadence() {
		...
		return Math.round((float) (mod((stridesNow - stridesThen), 128)) / timeSinceOldestReadingSecs * 60);
	}

	/**
	 * Modulo operation with positive return values, Java's remainder operator
	 * doesn't change sign.
	 *
	 * @return x mod y
	 */
