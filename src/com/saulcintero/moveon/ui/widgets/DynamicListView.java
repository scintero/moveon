...
public class DynamicListView extends ListView {
	...
	private Bitmap getBitmapWithBorder(View v) {
		...
		paint.setColor(getResources().getColor(R.color.holo_gray_dark));
	...
	private void handleCellSwitch() {
		...
		if (isBelow || isAbove) {
			...
			swapElements(mActionList, originalItem, getPositionForView(switchView));
	...
	private void swapElements(@SuppressWarnings("rawtypes") ArrayList arrayList, int indexOne, int indexTwo) {
	...
	private final static TypeEvaluator<Rect> sBoundEvaluator = new TypeEvaluator<Rect>() {
		public Rect evaluate(float fraction, Rect startValue, Rect endValue) {
			return new Rect(interpolate(startValue.left, endValue.left, fraction), interpolate(
					startValue.top, endValue.top, fraction), interpolate(startValue.right, endValue.right,
