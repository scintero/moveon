...
import com.saulcintero.moveon.sensors.ant.AntSensorManager.ChannelStates;
...
public abstract class ChannelConfiguration {
	 ...
	 * @param message
	 *            the message
	 * @param antSensorValue
	 *            the ant sensor value
	 */
	 ...
	 *
	 * @param isDeinitializing
	 *            true if isDeinitializing
	 */
